...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['Clown Team'],
		['OneilR',				'oni',				'Director, Artist, Animator, Composer',				'https://twitter.com/OneilR_NG',		0xFFFFDD33],
		['snowy~.',				'snowy',			'Programmer and Charter',							'https://twitter.com/neuroxrd',			0xFFC30085],
		[''],
		['Clown Special Thanks'],
		['Shadow Mario',		'shadowmario',		'Programming Help',									'https://twitter.com/Shadow_Mario_',	0xFFFFDD33],
		['shubs',				'shubs',			'Programming Help',									'https://twitter.com/yoshubs',			0xFF4494E6],
		[''],
		['Psych Engine Team'],
